 ...
 * in a uniform manner.
 * <p>
 * SingletonBeanRegistry顶层接口，单例bean注册器接口，registerSingleton方法，注册单例bean，不会调用InitializingBean的afterPropertiesSet方法。
 * getSingleton获取单例对象，containsSingleton是否包含单例对象，getSingletonNames获取单例对象的名称集合。
 *
